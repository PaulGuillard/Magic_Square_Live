...
.get('/', function(req, res) {
    ...
    res.sendFile(path.join(__dirname+'../../../../../../var/www/html/magic_square/Views/welcome_Magic_Square.php'));
    //path.join(__dirname+'/Views/setup_Magic_Square.php'));
})

.get('/creer', function(req, res){
    res.header('Content-type', 'text/html');
    res.sendFile(path.join(__dirname+'../../../../../../var/www/html/magic_square/Views/setup_Magic_Square.php'));
})
...
.get('/rejoindre', function (req, res) {
    res.header('Content-type', 'text/html');
    res.sendFile(path.join(__dirname+'../../../../../../var/www/html/magic_square/Views/join_Magic_Square.php')); //path permet de definir un chemin absolu, indispensable avec Express
})
...
.get('/game_on', function(req, res){
    res.header('Content-type', 'text/html');
    res.sendFile(path.join(__dirname+'../../../../../../var/www/html/magic_square/open_Magic_Square.html')); 
});
