...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../Public/CSS/Style_Coronideas_Fr.css"><!-- http://51.178.87.117/app/magic_square/Magic_Square_Live -->
    </head>
    ...
    <body>
        <article id="Magic_Square">
            ...
            <div class="Article_Picture_Box">
                <figure>
                    <img src="../Public/Images/Magic_Square.jpg" class="Article_Picture" /><!-- http://51.178.87.117/app/magic_square/Magic_Square_Live -->
